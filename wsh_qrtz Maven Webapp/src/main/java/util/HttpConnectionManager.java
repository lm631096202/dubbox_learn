...
//     * 每个路由的默认最大连接数
//     */  
//    public static final int MAX_ROUTE_CONNECTIONS = 5000;
//    
//    /** 
//     * 连接超时时间
//     */  
...
//     * 默认目标主机
//     */
//    private static final HttpHost DEFAULT_TARGETHOST = new HttpHost("http://localhost", 80);
//    
//    /**
...
////
////    //定义一个共有的静态方法，返回该类型实例
////    public static HttpConnectionManager getIstance() { 
...
//     * @return 页面代码
//     */
//    public String getHtml(String url,List<NameValuePair> data) {
//        HttpHost proxyHost = new HttpHost("127.0.0.1", 80);//代理
//        
//        String html = getHtml(url, proxyHost,data);
//        
//         
//        
...
//     * @return 页面代码
//     */
//    public String getHtml(String url, HttpHost proxyHost,List< NameValuePair> data) {
//        String html = "";
//        HttpPost httpPost = new HttpPost(url);
//        httpPost.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY, proxyHost);//设置代理
//        try {
//			UrlEncodedFormEntity formEntiry = new UrlEncodedFormEntity(data,"UTF-8");
...
//                if(httpEntity != null){
//                   String html1 = readHtmlContentFromEntity(httpEntity);
...
//    
// 
//	public static String getFromHttp(String Url,List<NameValuePair> data){  
//			HttpConnectionManager httpConnectionManager = new HttpConnectionManager();
//	        Date start = new Date();
//	        String SubmitResult=httpConnectionManager.getHtml(Url,data);
//		 return SubmitResult;
//		
//	}
//    
...
//         	
//             Date start = new Date();
//             List<NameValuePair> enddata= new ArrayList<NameValuePair>();
//             enddata.add(new BasicNameValuePair("job_id","5"));
//             enddata.add(new BasicNameValuePair("i","5"+i));
//             httpConnectionManager.getHtml("http://lanxiaoyu.zb/home/Studentapi/student_statistics",enddata);
//             Date end = new Date();
